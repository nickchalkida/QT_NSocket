#############################################################################
# Makefile for building: NSocket
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  NSocket.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile NSocket.pro
#############################################################################
...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -Iqtquick2applicationviewer -I/usr/include/qt5 -I/usr/include/qt5/QtQuick -I/usr/include/qt5/QtQml -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64
...
SOURCES       = main.cpp \
		N_SOCKET.cpp \
		qtquick2applicationviewer/qtquick2applicationviewer.cpp moc_N_SOCKET.cpp \
...
Makefile: NSocket.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile NSocket.pro
...
dist: 
	@test -d .tmp/NSocket1.0.0 || mkdir -p .tmp/NSocket1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/NSocket1.0.0/ && $(COPY_FILE) --parents N_SOCKET.h qtquick2applicationviewer/qtquick2applicationviewer.h .tmp/NSocket1.0.0/ && $(COPY_FILE) --parents main.cpp N_SOCKET.cpp qtquick2applicationviewer/qtquick2applicationviewer.cpp .tmp/NSocket1.0.0/ && (cd `dirname .tmp/NSocket1.0.0` && $(TAR) NSocket1.0.0.tar NSocket1.0.0 && $(COMPRESS) NSocket1.0.0.tar) && $(MOVE) `dirname .tmp/NSocket1.0.0`/NSocket1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/NSocket1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_N_SOCKET.cpp moc_qtquick2applicationviewer.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_N_SOCKET.cpp moc_qtquick2applicationviewer.cpp
moc_N_SOCKET.cpp: /usr/include/qt5/QtCore/QtCore \
...
moc_qtquick2applicationviewer.cpp: /usr/include/qt5/QtQuick/QQuickView \
	...
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include qtquick2applicationviewer/qtquick2applicationviewer.h -o moc_qtquick2applicationviewer.cpp
...
N_SOCKET.o: N_SOCKET.cpp N_SOCKET.h \
		/usr/include/qt5/QtCore/QtCore \
		/usr/include/qt5/QtCore/QtCoreDepends \
		/usr/include/qt5/QtCore/qabstractanimation.h \
		/usr/include/qt5/QtCore/qobject.h \
		...
		/usr/include/qt5/QtWidgets/qtabwidget.h \
		/usr/include/qt5/QtWidgets/qrubberband.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o N_SOCKET.o N_SOCKET.cpp
...
moc_N_SOCKET.o: moc_N_SOCKET.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_N_SOCKET.o moc_N_SOCKET.cpp
...
uninstall_itemfolder_01: FORCE
	...
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/NSocket/qml/ 


install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/NSocket/bin || mkdir -p $(INSTALL_ROOT)/opt/NSocket/bin
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/opt/NSocket/bin/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/opt/NSocket/bin/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/NSocket/bin/ 
